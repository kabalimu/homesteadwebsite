...
<form  @submit.prevent="saveCategories" >
    ...
    <div  v-for="(category, index) in categories"  :key="category.id">
          <input type="text"  v-model="category.name" @input="update($event,'name', index)"   :ref="category.name">
          <input type="number" v-model="category.display_order"  @input="update($event,'display_order', index)">
          ...
          <div> 
            ...
            <input type="text" v-model.lazy="category.image"  @change="update($event,'image', index)">  
          </div>
          <hr>
    </div>
